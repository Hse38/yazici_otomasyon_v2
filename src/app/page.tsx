  ...
  return (
    <div className="bg-background text-foreground m-0 p-0">
      ...
      <main className="m-0 p-0">
        ...
        <section
          id="hero"
          className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden hero-gradient"
          aria-label="Hero"
        >
          {/* Grid overlay */}
          ...
          {/* Floating orbs */}
          <div className="absolute top-1/4 left-1/4 h-96 w-96 rounded-full bg-accent/8 blur-[120px] pointer-events-none" aria-hidden />
          <div className="absolute bottom-1/3 right-1/4 h-64 w-64 rounded-full bg-navy-light/15 blur-[80px] pointer-events-none" aria-hidden />

          {/* Floating geometric particles */}
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="absolute border border-white/8 pointer-events-none"
              style={{
                width: `${20 + i * 12}px`,
                height: `${20 + i * 12}px`,
                top: `${15 + i * 13}%`,
                ...
                borderRadius: i % 2 === 0 ? "0" : "4px",
              }}
              aria-hidden
            />
          ))}

          <div className="relative z-10 mx-auto max-w-6xl px-6 text-center sm:px-10 lg:px-20">
            {/* Kicker badge */}
            <motion.div
            ...
            <motion.div
              ...
              className="mx-auto mt-6 h-0.5 w-16 origin-left bg-gradient-to-r from-accent to-transparent"
            ...
            >
              <a
                href="#contact"
                className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-accent/25 transition hover:bg-accent/90 hover:shadow-accent/40 hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/8 px-7 py-3.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:border-white/35 hover:bg-white/15 hover:-translate-y-0.5"
              >
          ...
          <motion.a
            ...
            className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/40 transition hover:text-white/70"
          >
            <motion.span
            ...
            />
            <motion.svg
              width="12" height="7" viewBox="0 0 12 7" fill="none" aria-hidden
              animate={{ y: [0, 4, 0] }}
        ...
        <section className="relative border-b border-navy/10 bg-navy py-16">
          <div className="mx-auto grid max-w-6xl gap-0 px-6 sm:px-10 lg:px-20 md:grid-cols-3 md:divide-x md:divide-white/10">
            {content.counters.map((counter, i) => (
              <motion.div
                ...
                className="flex flex-col items-center py-8 md:py-0 text-center"
              >
                <Counter {...counter} />
